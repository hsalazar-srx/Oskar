...
| Date-effective supersession write-back to Movex (PDS001/PDS002MI, status ladder, error log) | Slice E (outbox + `depends_on`, UpdComponent close-then-add, existing recovery panel) |
