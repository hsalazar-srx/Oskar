...
| R-12 | **Stargile MPDDOC drawing creation is not an MI program** | Medium | Medium | Active | Investigation item for `@developer-dotnet`. If direct DB2, movex-rest-api needs custom endpoint. Resolve before Sprint 2 design. |
